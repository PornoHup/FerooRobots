...
buttons = {
  ...
  "add_to_group": InlineKeyboardMarkup([[InlineKeyboardButton('️✨️ Gruba Ekle ️✨️', url=f'https://t.me/{Config.BOT_USERNAME}?startgroup=true')]]),
}
...
def song(client, message):
    ...
    try:
        ...
        m.edit("Aradığınız müzik bulunamadı 😔")
        print(str(e))
        return
    m.edit(f"🎵**{title}**")
    try:
...
'''
        ...
        m.edit(f'**⚠️Beklenmedik bir hata oluştu.**\n**Lütfen hatayı @{Config.OWNER_NAME} sahibime haberdar et!**')
        print(e)
